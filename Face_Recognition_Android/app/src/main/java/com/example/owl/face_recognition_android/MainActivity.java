package com.example.owl.face_recognition_android;
...
public class MainActivity extends AppCompatActivity {
    ...
    //private static final String MODEL_FILE = "file:///android_asset/emotions_detection.pb";
    ...
    private void displayResults(float[] results) {
        if (results[0] > results[1]) {
            ...
            textView.setText("Prediction: Not sure");
        }
    }
